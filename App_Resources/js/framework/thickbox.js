...
var tb_pathToImage = "../App_Themes/Default/img/loadingAnimation.gif";
	...
	try {
	   ...
	   var urlType = baseURL.toLowerCase().match(urlString);
		...
		if(urlType == '.jpg' || urlType == '.jpeg' || urlType == '.png' || urlType == '.gif' || urlType == '.bmp'){//code to show images
            ...
            h90 = Math.round(h90 * .97); 
            var w90 = $(window).width(); 
            w90 = Math.round(w90 * .95); 
            TB_WIDTH = (params['width']*1) + 30 || w90; //defaults to 90% if no paramaters were added to URL
			TB_HEIGHT = (params['height']*1) + 40 || h90; //defaults to 90% if no paramaters were added to URL
