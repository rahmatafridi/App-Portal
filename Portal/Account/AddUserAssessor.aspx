<%@ Page Language="C#" MasterPageFile="~/Portal/PortalMaster.master" AutoEventWireup="true" CodeFile="AddUserAssessor.aspx.cs" Inherits="Admin_AddUserAssessor" Title="Add New User" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="BodyContent" Runat="Server">    
    ...
    <h1 class="title-regular">Add Assessor User</h1>

       <p>
       Create new Assessor user on the system.
    </p>
    ...
    <asp:Table runat = "server" ID = "AddUserTable" CellPadding = "0" CellSpacing = "0">
        ...
        <asp:TableRow>
            ...
            <asp:TableCell>
                <asp:TextBox ID="txtUserName" runat="server"></asp:TextBox> (use an email address)
            </asp:TableCell>
        </asp:TableRow>
        ...
        <asp:TableRow>
       <asp:TableCell>
                <asp:Label Width = "200" ID="lblAssessorId" runat="server" Text="Assessor Id"></asp:Label>
            </asp:TableCell>
            <asp:TableCell>
                <asp:TextBox ID="txtAssessorId" runat="server"   ></asp:TextBox>
            </asp:TableCell>
        </asp:TableRow>
