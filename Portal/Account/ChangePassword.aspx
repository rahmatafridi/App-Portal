...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="BodyContent">
    ...
    <h1 class="title-regular">Change Password</h1>
        ...
        <ChangePasswordTemplate>
            ...
            <div class="accountInfo">
                ...
                <p class="submitButton">
                     ...
                     <asp:LinkButton SkinID="LinkButton" runat="server" ID="CancelPushButton" CausesValidation="False"
                     CommandName="Cancel" Text="Cancel"    />

     <asp:LinkButton SkinID="LinkButton" runat="server" ID="ChangePasswordPushButton" 
