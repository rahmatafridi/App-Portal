...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContainer" runat="server">
    ...
    <%-- <link   href="../../App_Resources/css/ThemeBlue.css" rel="stylesheet" type="text/css" />
    --%>

    <%--<script type='text/javascript' src='../../App_Resources/js/modal/jquery.js'></script>--%>
    ...
    <script type="text/javascript">
        ...
        function GetApplicationForDisplay(ctrl) {
            ...
            $.ajax({
                type: "POST",
                url: "Default.aspx/GetApplicationForDisplay",
                data: '{id: "' + sId + '" }',
...
<asp:Content ID="cBodyContent" runat="server" ContentPlaceHolderID="BodyContent">
    ...
    <h4 class="title-regular">Admin online application form  
    ...
    <atk:TabContainer ID="tabs" runat="server" Width="100%" Height="100%" CssClass="ajax__tab_yuitabview-theme">
        <atk:TabPanel ID="tab_progress" runat="server" HeaderText="Submitted/In Progress">
            <HeaderTemplate>Submitted/In Progress</HeaderTemplate>
            <ContentTemplate>
                ...
                <asp:UpdatePanel ID="upnlOutstanding" runat="server" ChildrenAsTriggers="true" UpdateMode="Conditional">
                    <ContentTemplate>
                        <h4>Existing applications progress</h4>
                        <br />
                        ...
                        <asp:GridView ID="grdViewApplications" runat="server" AutoGenerateColumns="False"
                            ...
                            PageSize="50" AllowSorting="true" Visible="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Submitted on/Completed" Visible="True" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="20%" ItemStyle-Width="20%">
                                    <ItemTemplate>
                            ...
                            Width="70px" CssClass="DatepickerInput"></asp:TextBox>--%>
                                ...
                                <asp:TemplateField HeaderText="" ShowHeader="true" HeaderStyle-Width="20px" ItemStyle-Width="30%">
                                    <ItemTemplate>
                                        ...
                                        <asp:LinkButton OnClick="btn_Edit_Click" SkinID="LinkButton" ID="btn_Edit" Text='Continue/Amend' runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="" ShowHeader="true" HeaderStyle-Width="20px" ItemStyle-Width="40px">
                                    <ItemTemplate>
                ...
                <asp:SqlDataSource ID="SDS_App_GetUserApplications" runat="server"
                    ...
                    SelectCommand="oscauser.SP_App_GetUserApplicationsForAdmin"
                ...
                <asp:GridView ID="grid_userapplications" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="By User" Visible="True" ItemStyle-Font-Bold="False" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="2%" ItemStyle-Width="2%">
                            <ItemTemplate>
                                <%-- <asp:Label ID="lbl_Username" Text='info' ToolTip='<%# Eval("AppUser_CreatedByUser")%>' runat="server"></asp:Label>--%>
                                <img src="../../App_Resources/images/uploader/Message_Information.png" runat="server" title='<%# Eval("AppUser_CreatedByUser")%>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <%--  <asp:TemplateField HeaderText="Unique Learner Ref" Visible="True" ItemStyle-Font-Bold="False" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="20%" ItemStyle-Width="20%">
                    <ItemTemplate>
                        <asp:Label ID="lbl_ULR" Text='<%# Eval("ULR")%>' runat="server"></asp:Label>
        ...
        <atk:TabPanel ID="tab_notsubmitted" runat="server" HeaderText="Not Submitted">
            <HeaderTemplate>Not Submitted</HeaderTemplate>

            <ContentTemplate>
                <p>
                    Applications not yet submitted by applicants 
        <asp:SqlDataSource ID="SDS_App_GetUserApplicationsNoSubmitted" runat="server"
            ConnectionString="<%$ ConnectionStrings:DBConnection %>"
            SelectCommand="oscauser.SP_App_GetUserApplicationsForAdmin"
            SelectCommandType="StoredProcedure">
            <SelectParameters>
                <asp:Parameter DefaultValue="0" Name="submitted" Type="Int32" />
            </SelectParameters>
        </asp:SqlDataSource>
                    <asp:GridView ID="grid_userapplicationsNotSubmitted" runat="server"
                        AutoGenerateColumns="False"
                        OnRowDataBound="grid_userapplicationsNotSubmitted_OnRowDataBound"
                        DataSourceID="SDS_App_GetUserApplicationsNoSubmitted" PageSize="30"
                        Width="100%" EnableModelValidation="True">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="By User" Visible="True" ItemStyle-Font-Bold="False" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="30%" ItemStyle-Width="40%">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Name" Visible="True" ItemStyle-Font-Bold="False" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="30%" ItemStyle-Width="40%">
                                <ItemTemplate>
                                    <asp:Label ID="lbl_applicantname" Text='<%# Eval("applicantname")%>' runat="server"></asp:Label>
                    ...
                    <ItemTemplate>
                        <asp:Label ID="lbl_ULR" Text='<%# Eval("ULR")%>' runat="server"></asp:Label>
                            ...
                            <asp:TemplateField HeaderText="Date" Visible="True" ItemStyle-Font-Bold="False" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="10%" ItemStyle-Width="20%">
                                <ItemTemplate>
                                    <asp:Label ID="lbl_CreatedOn" Text='<%# Eval("CreatedOn")%>' runat="server"></asp:Label>
                            ...
                            <asp:TemplateField HeaderText="" ShowHeader="true" HeaderStyle-Width="20px" ItemStyle-Width="50px">
                                <ItemTemplate>
                                    <asp:LinkButton OnClick="btn_EditNotSubmitted_Click" SkinID="LinkButton" ID="btn_EditNotSubmitted" Text='Continue/Amend' runat="server" />
                                </ItemTemplate>
                            </asp:TemplateField>
        ...
        <atk:TabPanel ID="tab_rejected" runat="server" HeaderText="Rejected">
            <HeaderTemplate>Rejected</HeaderTemplate>
            <ContentTemplate>
                <p>
                    Rejected Applications

        <asp:SqlDataSource ID="SDS_App_GetUserApplicationsRejected" runat="server"
            ConnectionString="<%$ ConnectionStrings:DBConnection %>"
            SelectCommand="[oscauser].SP_App_GetUserApplicationsForAdminRejected"
            SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                    <asp:GridView ID="grid_userapplicationsRejected" runat="server"
                        AutoGenerateColumns="False"
                        OnRowDataBound="grid_userapplicationsRejected_OnRowDataBound"
                        DataSourceID="SDS_App_GetUserApplicationsRejected" PageSize="30"
                        Width="100%" EnableModelValidation="True">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Name" Visible="True" ItemStyle-Font-Bold="False" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="40%" ItemStyle-Width="40%">
                                <ItemTemplate>
                                    <asp:Label ID="lbl_applicantname" Text='<%# Eval("applicantname")%>' runat="server"></asp:Label>
                    ...
                    <ItemTemplate>
                        <asp:Label ID="lbl_ULR" Text='<%# Eval("ULR")%>' runat="server"></asp:Label>
                            ...
                            <asp:TemplateField HeaderText="Date" Visible="True" ItemStyle-Font-Bold="False" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="20%" ItemStyle-Width="20%">
                                <ItemTemplate>
                                    <asp:Label ID="lbl_CreatedOn" Text='<%# Eval("CreatedOn")%>' runat="server"></asp:Label>
                            ...
                            <asp:TemplateField HeaderText="Rejected on" Visible="True" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="50px" ItemStyle-Width="50px">
                                <ItemTemplate>
                                    <asp:Label ID="lbl_RejectedOn" runat="server" Text='<%# Bind("RejectedOn") %>'></asp:Label>
        ...
        <atk:TabPanel ID="tab_deleted" runat="server" HeaderText="Deleted">
            <HeaderTemplate>Deleted</HeaderTemplate>
            <ContentTemplate>
                <p>
                    Deleted Applications
                <asp:SqlDataSource ID="SDS_App_GetUserApplicationsDeleted" runat="server"
                    ConnectionString="<%$ ConnectionStrings:DBConnection %>"
                    SelectCommand="oscauser.SP_App_GetUserApplicationsForAdminDeleted"
                    SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                    <asp:GridView ID="grid_userapplicationsDeleted" runat="server"
                        AutoGenerateColumns="False"
                        OnRowDataBound="grid_userapplicationsDeleted_OnRowDataBound"
                        DataSourceID="SDS_App_GetUserApplicationsDeleted" PageSize="30"
                        Width="100%" EnableModelValidation="True">
                    ...
                    <ItemTemplate>
                        <asp:Label ID="lbl_ULR" Text='<%# Eval("ULR")%>' runat="server"></asp:Label>
                            ...
                            <asp:TemplateField HeaderText="Deleted on" Visible="True" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="50px" ItemStyle-Width="50px">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="" ShowHeader="true" HeaderStyle-Width="20px" ItemStyle-Width="50px">
                                <ItemTemplate>
                                    <asp:LinkButton OnClick="btnRecover_Click" SkinID="LinkButton" ID="btnRecover" Text='Recover' runat="server" />
                                </ItemTemplate>
                            </asp:TemplateField>
        ...
        <atk:TabPanel ID="tab_enrolled" runat="server" HeaderText="Enrolled">
            <HeaderTemplate>Enrolled</HeaderTemplate>
            <ContentTemplate>
                <p>
                    Enrolled Applications
                <asp:SqlDataSource ID="SDS_App_GetUserApplicationsEnrolled" runat="server"
                    ConnectionString="<%$ ConnectionStrings:DBConnection %>"
                    SelectCommand="oscauser.SP_App_GetUserApplicationsForAdminEnrolled"
                    SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                    <asp:GridView ID="grid_userapplicationsEnrolled" runat="server"
                        AutoGenerateColumns="False"
                        OnRowDataBound="grid_userapplicationsEnrolled_OnRowDataBound"
                        DataSourceID="SDS_App_GetUserApplicationsEnrolled" PageSize="30"
                        Width="100%" EnableModelValidation="True">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Id" Visible="True" HeaderStyle-Width="10%" ItemStyle-Width="5%">
                                <ItemTemplate>
                                    <asp:Label ID="lbl_AppId" Text='<%# Eval("AppUser_App_Id")%>' runat="server" Visible="True"></asp:Label>
                                    <asp:Label ID="lbl_UserId" Text='<%# Eval("AppUser_UserId")%>' runat="server" Visible="false"></asp:Label>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Learner Id" Visible="True" ItemStyle-Font-Bold="False" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="10%" ItemStyle-Width="10%">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Created on" Visible="True" ItemStyle-Font-Bold="False" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="10%" ItemStyle-Width="10%">
                                <ItemTemplate>
                                    <asp:Label ID="lbl_CreatedOn" Text='<%# Eval("CreatedOn")%>' runat="server"></asp:Label>
                            ...
                            <asp:TemplateField HeaderText="Enrolled on" Visible="True" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Left" HeaderStyle-Width="10%" ItemStyle-Width="10%">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="" ShowHeader="true" HeaderStyle-Width="20px" ItemStyle-Width="30%">
                                <ItemTemplate>
                                    <a href="#" class="button medium blue" onclick='GetApplicationForDisplay2(this)' border="0" data-txt='<%# Eval("AppUser_App_Id") %>'>Printout</a>
                                </ItemTemplate>
                            </asp:TemplateField>
