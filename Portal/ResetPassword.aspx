<%@ Page Title="Reset Password" Language="C#" MasterPageFile="~/Portal/PortalMaster.master" AutoEventWireup="true"
    CodeFile="ResetPassword.aspx.cs" Inherits="portal_resetpassword" %>
...
<asp:Content ID="cBodyContent" runat="server" ContentPlaceHolderID="BodyContent">
    ...
    <p>
        Please enter your email and we will email you with your new password.
     </p>
    ...
    <fieldset class="login">
        ...
        />
           ...
           <asp:LinkButton ID="LoginButton" SkinID="LinkButton" runat="server" OnClick="LoginButton_Click"   Text="Send"  />
