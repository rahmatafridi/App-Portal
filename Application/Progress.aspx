<%@ Page Title="Application progress" Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true"
    CodeFile="Progress.aspx.cs" Culture="en-GB" Inherits="Application_Progress" %>
...
<asp:Content ID="cHeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            //newx
            /********************************************************************************/
            $(".DatepickerInputApplication").datepicker({
                changeMonth: false,
                changeYear: false,
                dateFormat: 'dd/mm/yy',
                yearRange: '0:+0',
...
<asp:Content ID="cBodyContent" runat="server" ContentPlaceHolderID="BodyContent">
    ...
    <br />
    <asp:Wizard ID="Wizard1" runat="server" DisplaySideBar="false" HeaderText="Application Form"
                            ...
                            <div class="well">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4 col-sm-4">
                                            <asp:DropDownList ID="ddlIsLivedEULast3Years" runat="server" OnClientClick="DisableValidator('txtLivedEntryDate');" class="form-control input-sm" DataTextField="Opt_Title" DataValueField="Opt_Value" DataSourceID="SDS_YESNO"></asp:DropDownList>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4 col-sm-4">
                                            ...
                                            <asp:CompareValidator
                                                ...
                                                ErrorMessage="Please enter a valid date." class="required-field-indicator" CultureInvariantValues="false">
                                            </asp:CompareValidator>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4 col-sm-4">
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvEUEAA" runat="server" EnableClientScript="True"
                                                ControlToValidate="ddlEUEAANational" ErrorMessage="* An answer is required " class="required-field-indicator" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4 col-sm-4">
                                            <asp:DropDownList ID="ddlAnyDisability" runat="server" class="form-control input-sm" DataTextField="Opt_Title" DataValueField="Opt_Value"
                                                DataSourceID="SDS_YESNO" OnClientClick="DisableValidator('ddlAnyDisabilityPrimary');">
                                            </asp:DropDownList>
